...
export const BudgetsIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zM8.75 8.5c0-.414.336-.75.75-.75h5c.414 0 .75.336.75.75v.25h.5c.552 0 1 .448 1 1v4c0 .552-.448 1-1 1h-.5v.25c0 .414-.336.75-.75.75h-5c-.414 0-.75-.336-.75-.75v-.25h-.5c-.552 0-1-.448-1-1v-4c0-.552.448-1-1-1h.5v-.25zm1.5.25h3.5v5h-3.5v-5z"/>
    </svg>
);
